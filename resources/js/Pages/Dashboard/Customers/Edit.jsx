                ...
                <div className="max-w-3xl">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-4">
                        ...
                        <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Akses Portal Pelanggan</p>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                                {customer.password ? "Pelanggan sudah memiliki akses portal. Isi password baru untuk menggantinya." : "Opsional. Isi password agar pelanggan bisa login ke portal."}
                            </p>
                            <Input
                                type="password"
                                label="Password Portal Baru"
