...
class SampleDataSeeder extends Seeder
{
    ...
    {
        $customers = collect([
            ['name' => 'Andi Nugraha', 'no_telp' => '081211111111', 'address' => 'Jl. Melati No. 21, Bandung', 'password' => 'password'],
            ['name' => 'Bunga Maharani', 'no_telp' => '081312345678', 'address' => 'Jl. Mawar No. 5, Jakarta', 'password' => 'password'],
            ['name' => 'Cici Amelia', 'no_telp' => '081512340000', 'address' => 'Jl. Anggrek No. 17, Surabaya', 'password' => 'password'],
            ['name' => 'Davin Pradipta', 'no_telp' => '085612349911', 'address' => 'Jl. Kenanga No. 2, Yogyakarta', 'password' => 'password'],
            ['name' => 'Eko Saputra', 'no_telp' => '087712348822', 'address' => 'Jl. Cemara No. 45, Semarang'],
            ['name' => 'Fitri Lestari', 'no_telp' => '082213345566', 'address' => 'Jl. Sakura No. 7, Medan', 'password' => 'password'],
            ['name' => 'Gina Putri', 'no_telp' => '081399887766', 'address' => 'Jl. Dahlia No. 12, Malang'],
            ['name' => 'Hendra Wijaya', 'no_telp' => '085544332211', 'address' => 'Jl. Flamboyan No. 8, Denpasar'],
        ]);
